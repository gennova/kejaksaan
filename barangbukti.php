...
<?php
include 'config.php';
$sql_query = "select * from home where menu='BARANG BUKTI'";
			...
			<div class="agileinfo_news_original_grids">
				...
				<div class="col-md-3 agileinfo_news_original_grids_right">
					<div class="w3layouts_add_market">
						<div style="text-align: center"><b>KEPALA SEKSI<br/>PENGOLAHAN BARANG BUKTI DAN BARANG RAMPASAN</b><br/></div>
						<img src="images/Bilal.jpg" alt=" " class="img-responsive" />
						
                      <div style="text-align: center"><br />BILAL BIMANTARA, S.H <br />JAKSA MUDA</div>
						<hr/>
