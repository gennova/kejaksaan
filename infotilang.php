...
<?php
include 'config.php';
$sql_query = "select * from datatilang";
		...
		<div class="w3ls_header_middle">
			<div class="container">
				<div class="agileits_logo">
					<h1><a href="index.php"><span>&nbspKEJAKSAAN NEGERI</span> KABUPATEN LANDAK<i>&nbsp&nbsp Jaringan Dokumentasi dan Informasi Hukum</i></a></h1>
				</div>
	...
	<div class="banner-bottom">
		...
		<div class='agileinfo_marquee'>
			<div data-speed="10" class="marquee">
				<ul>
					<li><a href="about.html">Perkembangan terbaru data Covid 19 Indonesia<span>\</span></a></li>
					<li><a href="about.html">Apakah akan terjadi reshufle kabinet lagi?</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="agileinfo_news_original_grids">
				<div class="col-md-9 agileinfo_news_original_grids_left1">
					<b>DATA SIDANG TILANG</b><br />
					
					<?php
                    while($row = mysqli_fetch_assoc($result)) {
                    	echo "<div class='tilang'>".$row['nama'].' '.$row['jadwalsidang'].' '.$row['keterangan']."</div>";
                    }
                    ?>
				</div>
