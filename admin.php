		...
		<div class="w3ls_header_middle">
			<div class="container">
				<div class="agileits_logo">
					<h1><a href="index.html"><span>&nbspJDIH</span> Mahakam ULU<i>&nbsp&nbsp Jaringan Dokumentasi dan Informasi Hukum</i></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<nav class="wthree_nav">
						<ul class="nav navbar-nav nav_1">
							<li class="act"><a href="#">Beranda</a></li>
							<li><a href="#">Tentang Kami</a></li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Jenis Produk Hukum<span class="caret"></span></a>				
								<div class="dropdown-menu w3ls_vegetables_menu">
									<ul>	
										<li><a href="#">Peraturan Daerah</a></li>
										<li><a href="#">Peraturan Walikota</a></li>
									</ul>             
								</div>
							</li>
	...
	<div class="banner-bottom">
		...
		<div class='agileinfo_marquee'>
			<div data-speed="10" class="marquee">
				<ul>
					<li><a href="single.html">Perkembangan terbaru data Covid 19 Indonesia<span>\</span></a></li>
					<li><a href="single.html">Apakah akan terjadi reshufle kabinet lagi?</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="agileinfo_news_original_grids w3_agile_news_market_grids">
				<div class="col-md-9 w3ls_mutual_funds_grid1_jkjk">
					<div class="agileits_about_grids w3ls_products_grid">
						<h3>Contoh page Tentang Kami</h3>
...
<!-- footer -->
	<div class="footer">
		<div class="container">
			...
			<p>© 2020 JDIH | Design by <a href="#">Tendy Developer</a></p>
		</div>
	</div>
<!-- //footer -->
<!-- stacked-graph -->
