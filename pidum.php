...
<?php
include 'config.php';
$sql_query = "select * from home where menu='PIDANA UMUM'";
			...
			<div class="agileinfo_news_original_grids">
				...
				<div class="col-md-3 agileinfo_news_original_grids_right">
					<div class="w3layouts_add_market">
						<div style="text-align: center"><b>KEPALA SEKSI<br/>BIDANG TINDAK PIDANA UMUM</b><br/></div>
						<img src="images/Heri.jpg" alt=" " class="img-responsive" />
						
                      <div style="text-align: center"><br />HERI SUSANTO, S.H., M.H. <br />JAKSA MUDA</div>
						<hr/>
